    ...
    public static void main(String[] args) {
        ...
        while (choice.equalsIgnoreCase("y")) {
          ...
          //          "Enter monthly investment: ", 0, 1000);
            ...
            double monthlyInvestment = Console.getDouble(sc, "Enter monthly investment: ", 0, 1000);
          //double interestRate = getDoubleWithinRange(sc,
          //        "Enter yearly interest rate: ", 0, 30);
            double interestRate = Console.getDouble(sc, "Enter yearly interest rate: ", 0, 30);
          //  int years = getIntWithinRange(sc,"Enter number of years: ", 0, 100);
            int years = Console.getInt(sc,"Enter number of years: ", 0, 100);
